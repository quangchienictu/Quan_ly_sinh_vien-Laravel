...
<main>
  ...
  <div class="container-fluid">
    ...
    <div class="container">
      ...
      <form action="khoa/them" class="needs-validation" method="post" novalidate>
        @csrf
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="pwd" placeholder="Tên khoa" name="tenKhoa" required>
