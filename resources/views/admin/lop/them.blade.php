...
<main>
  ...
  <div class="container-fluid">
    ...
    <div class="container">
      ...
      <form action="lop/them" class="needs-validation" method="post" novalidate>
        @csrf
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="pwd" placeholder="Tên Lớp" name="tenLop" required>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="sel1" name="maKhoa">
              @foreach ($khoa as $element)
                <option value="{{$element->maKhoa}}">{{$element->tenKhoa}}</option>
              @endforeach
            </select>
          </div>
